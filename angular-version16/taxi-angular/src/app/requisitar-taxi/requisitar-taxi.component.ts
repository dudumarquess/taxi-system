...
export class RequisitarTaxiComponent {
  ...
  onDataInicioChange(event: Event) {
    ...
    this.inicioData = input.value;
  }

  onHoraInicioChange(event: Event) {
    const input = event.target as HTMLInputElement;
    this.inicioHora = input.value;
  }

  onDataFimChange(event: Event) {
    const input = event.target as HTMLInputElement;
    this.fimData = input.value;
  }

  onHoraFimChange(event: Event) {
    const input = event.target as HTMLInputElement;
    this.fimHora = input.value;
  }
}
